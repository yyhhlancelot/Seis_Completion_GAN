...
dataset_base_path = os.path.expanduser("../Training_Data/seis_data")


trainset_path = dataset_base_path + '/' + 'train'
# trainset_path = dataset_base_path + '/' + 'train_batch'
...
def load_pickle_seisdata_train(pickle_path, dataset_path):
...
def load_pickle_seisdata_test(pickle_path, dataset_path):
    # if not os.path.exists(pickle_path):
...
def load_trainset_path(trainset_path):
    trainset_pickle_path = dataset_base_path + '/' + 'train_filename.pickle'
    return load_pickle_seisdata_train(trainset_pickle_path, trainset_path)

def load_validset_path():
    return load_pickle(validset_pickle_path, validset_path)

def load_testset_path():
    return load_pickle_seisdata_test(testset_pickle_path, testset_path)
